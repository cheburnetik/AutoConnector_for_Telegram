...
Андроид версия работает сама по себе, а Винде нужно поставить движок проксирования "СПЛИТ..." или "КОАЛЕСИНГ.." (в настройках). Либо подбирать тот, что лично у вас будет работать лучше, т.к. блокировки везде разные.
