...
Другими словами: это сканер тг-каналов и всевозможных подписок с публичными бесплатными проксями MTPrpto, с автоподстановкой в ваш Телеграм. Обновлять клиент Телеграма не нужно. Доступность проксей проверяет именно с вашего устройства и сетевого окружения. Работает на WiFi+LTE без VPN.
