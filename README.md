...
Рекомендую отключить фаервол типа COMODO, если используете: загоняет приложение в песочницу и его фаервол портит исходящие коннекты к MTProto проксям. Или запустите приложение в виртуалке, там полностью изменится TCP стек, поведение АвтоКоннектора будет иным.
