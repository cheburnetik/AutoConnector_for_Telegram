...
object Ar : Strings {
    ...
    override val recentAttempts = "آخر الاتصالات والفحوص"
    override val kindCheck = "فحص"
    override val kindTg = "Telegram"
    override val histWho = "مَن"
    override val histWhen = "متى"
    override val histReq = "طلب"
    override val histSess = "جلسة"
    override val histScan = "فحص"
    override val testNow = "اختبر الآن"
    override val testShort = "اختبار"
    override val testResult = "نتيجة الاختبار"
    override val testStop = "إيقاف"
    override val testingNow = "جارٍ الاختبار…"
    override val prewarmTitle = "تسخين المقابس (تجريبي)"
    override val prewarmHelp = "أبقِ بضعة مقابس بروكسي منبع متصلة مسبقًا حتى يتمكن اتصال " +
        "Telegram جديد من تخطي الاتصال/المصافحة. تجريبي: يستمر في إعادة الاتصال في " +
        "الخلفية، لذا يستهلك بيانات وقليلًا من CPU. لا تُرسَل بيانات وهمية (فذلك يُفسد " +
        "الجلسة الحقيقية) — تُدوَّر المقابس فقط. الأكثر فائدة مع بروكسيات FakeTLS."
    override val prewarmEnable = "تفعيل التسخين"
    override val prewarmModeDeferred = "مؤجَّل (TLS فقط)"
    override val prewarmModeDeferredSub = "أبقِ TCP + FakeTLS؛ أكمل التهيئة عند التسليم. لا يُلتزَم بـ DC — الأكثر واقعية."
    override val prewarmModeFull = "مصافحة كاملة"
    override val prewarmModeFullSub = "أبقِ مقابس متصلة بالكامل عبر مراكز DC؛ تُعاد فقط عند تطابق DC/الوسم. أقصر عمرًا."
    override val prewarmPoolLabel = "مقابس احتياطية"
    override val prewarmHoldLabel = "أبقِ كلًّا، ث"
    override val prewarmNote = "تدوير فقط (بلا إبقاء على مستوى التطبيق). يدوم المقبس ثوانٍ إلى ~دقيقة حسب البروكسي/DC."
    override val prewarmStatus = "التسخين"
    override fun prewarmStatusVal(ready: Int, holdSecs: Int) = "${ready} جاهز · أُبقي ${holdSecs}ث"
    override val prewarmStar = "برتقالي عريض = مقبس سُلِّم دافئًا من مجمَّع التسخين (تخطى الاتصال/المصافحة)"
    override fun prewarmTableTitle(holdSecs: Int) = "تسخين المقابس (أُبقي ${holdSecs}ث)"
    override val prewarmTableHelp = "«تسخين المقابس» يفتح بضعة مقابس بروكسي مسبقًا حتى يتمكن اتصال " +
        "Telegram جديد من تخطي الاتصال/المصافحة. يسرد هذا الجدول المقابس الجاري تسخينها: كم عاش كلٌّ " +
        "منها، وهل يستخدمه Telegram، والبيانات. فعِّله/أوقفه واضبطه (الوضع، عدد المقابس، مدة " +
        "الإبقاء) في «المزيد ← الإعدادات ← „تسخين المقابس (تجريبي)“»."
    override val prewarmNoneWarming = "لا مقابس قيد التسخين بعد"
    override val prewarmColAge = "العمر"
    override val prewarmColUse = "في TG؟"
    override val prewarmInUse = "في TG"
    override val prewarmNew = "جديد"
    override val lanShareTitle = "المشاركة عبر الشبكة المحلية (بوابة ويب)"
    override val lanShareDesc = "اسمح للأجهزة الأخرى على شبكة Wi-Fi هذه باستخدام AutoConnector هذا كبروكسي؛ سيحصل المتصفح الذي يفتح العنوان أدناه على صفحة بأفضل البروكسيات."
    override val lanShareUrlsLabel = "يتصل الجيران عبر:"
    override val lanShareNoIp = "لا يوجد عنوان على الشبكة المحلية — اتصل بـ Wi-Fi"
    override val lanFirewallTitle = "السماح على الشبكة المحلية"
    override val lanFirewallBody = "يفتح تفعيل هذا منافذ الترحيل لشبكتك المحلية. قد يسأل جدار حماية Windows (أو غيره) الآن عمّا إذا كان يسمح لـ AutoConnector — اختر السماح / نعم. إذا رفضته، فستُحجَب بيانات الجيران إلى AutoConnector ولن تكون الصفحة/البروكسي متاحة."
    override val lanFirewallConfirm = "تفعيل"
    override val lanInfoTitle = "ما فائدة هذا؟"
    override val lanInfoBody = "شغِّل AutoConnector على جهاز كمبيوتر أو هاتف واحد على شبكة Wi-Fi لديك، وعندها يمكن لكل جهاز آخر على الشبكة نفسها — بما في ذلك iPhone، الذي لا يدعمه هذا التطبيق مباشرة — أن يفتح العنوان في متصفح ويستخدمه فقط: صفحة بأفضل البروكسيات لإضافتها إلى Telegram الخاص بهم، أو هذا الجهاز نفسه كبروكسي SOCKS. جهاز واحد يعثر على البروكسيات ويحتفظ بها؛ والبقية يستعيرونه عبر الشبكة المحلية."
    override val volTriggerTitle = "مُشغِّل أزرار الصوت"
    override val volTriggerSub = "بدِّل البروكسي بنمط سريع من مفاتيح الصوت"
    override val volEnableLabel = "مراقبة أزرار الصوت"
    override val volHelpTitle = "ما هذا؟"
    override val volHelpBody = "على Android لا توجد اختصارات لوحة مفاتيح عامة، لذا يستخدم هذا أزرار الصوت بدلًا منها. أثناء التفعيل، يراقب AutoConnector في الخلفية نمطًا سريعًا من ضغطات رفع/خفض الصوت (مثل رفع-رفع-خفض-خفض). عند تعرّفه على أحدها، يفتح رابط tg:// لبروكسي جيد حي عشوائي حتى يلتقطه Telegram ويبدّل — طريقة سريعة وخفية لتدوير البروكسي دون فتح التطبيق. يستمر الصوت في العمل بشكل طبيعي (لا تُبتلَع الضغطات). يتطلب هذا وصول Accessibility (لقراءة مفاتيح الصوت في الخلفية ولفتح الرابط)؛ لا يُطلَب شيء حتى تفعِّل المفتاح. اضبط الحد الأقصى للوقت بين الضغطات أدناه؛ الأنماط المتعرَّف عليها مدرجة في الأسفل."
    override val volGrantTitle = "فعِّل Accessibility (مهم)"
    override val volGrantBody = "يحجب Android (خصوصًا 13+) خدمة Accessibility للتطبيقات غير المثبَّتة من Google Play — لهذا يظهر AutoConnector باهتًا ويقول \"إعداد مقيَّد\" / \"الوصول غير مسموح\".\n\nكيفية فك الحجب:\n1. افتح \"معلومات التطبيق\" (الزر أدناه، أو: الإعدادات ← التطبيقات ← AutoConnector for Telegram).\n2. اضغط قائمة ⋮ (الثلاث نقاط أعلى اليمين) ← \"السماح بالإعدادات المقيَّدة\" ← أكِّد.\n3. ارجع: الإعدادات ← Accessibility ← AutoConnector for Telegram ← فعِّله.\n\nإذا لم ترَ \"السماح بالإعدادات المقيَّدة\" — فجرِّب أولًا تفعيل المفتاح مرة في Accessibility (ستظهر رسالة الحجب)، ثم تصبح الخطوة 2 متاحة.\n\nعلى Xiaomi/MIUI وSamsung وغيرها قد يختلف المسار قليلًا — ابحث عن نفس ⋮ في \"معلومات التطبيق\". على Android 12 والأقدم لا يوجد عادةً قيد — فعِّله مباشرة.\n\nمفاتيح الصوت تُراقَب فقط، ولا تُحجَب أبدًا."
    override val volOpenAppInfo = "فتح \"معلومات التطبيق\""
    override val volAccessOn = "Accessibility: ممنوح"
    override val volAccessOff = "Accessibility: غير ممنوح"
    override val volOpenAccess = "فتح إعدادات Accessibility"
    override val volGapLabel = "أقصى مللي ثانية بين الضغطات"
    override val volPatternsTitle = "الأنماط المتعرَّف عليها"
    override val volPatternPick = "النمط"
    override val volPatternsLegend = "↑ = رفع الصوت، ↓ = خفض الصوت"
    override val volNoRights = "لا يملك التطبيق بعد إذنًا للتعامل مع أزرار الصوت — امنح الوصول باتباع الخطوات في أسفل هذه الصفحة."
    override val volGrantShort = "لا يوجد وصول Accessibility بعد. اقرأ الخطوات التفصيلية في أسفل هذه الصفحة، ثم اضغط \"تحقق\"."
    override val volCheck = "تحقق"
    override val volCheckOk = "✓ تم — مُنح الوصول، المُشغِّل يعمل."
    override val volCheckFail = "✗ لا وصول بعد — أكمل الخطوات أعلاه."
    override val volPatternsList = "↑↑↓↓ · ↓↓↑↑ · ↑↓↑↓ · ↓↑↓↑ · ↑↑↑↑ · ↓↓↓↓ · ↑↓↓↑ · ↓↑↑↓ · ↑↑↑↓↓↓ · ↓↓↓↑↑↑   (↑ = رفع الصوت، ↓ = خفض الصوت)"
    override val histLegend = "الأعمدة — مَن: ✓/✗ TG = اتصال Telegram حقيقي، فحص = فحص في الخلفية. متى: منذ كم. TCP/TLS/طلب: زمن المصافحة وأول طلب، م.ث. جلسة: كم دامت جلسة الترحيل. ↓/↑: بايتات مستلَمة / مُرسَلة عبر المضيف."
    override val tgOkTotalHint = "اتصالات Telegram / الناجحة / إجمالي الفحوص"
    override val breadthTitle = "اتساع اختيار المضيفين"
    override val breadthHelp = "اليسار = التزم بأفضل المضيفين المثبَتين؛ اليمين = جرِّب بأوسع نطاق ممكن عبر كل المضيفين الأحياء. عندما يستمر Telegram في تبديل منافذ الترحيل، يوسِّع التطبيق البحث تلقائيًا."
    override val breadthNarrow = "مثبَتون"
    override val breadthWide = "الأوسع"
    override val connTimeoutTitle = "مهلة الاتصال لكل مضيف"
    override val connTimeoutHelp = "كم يُنتظَر منبع واحد (TCP + TLS + أول رد MTProto) قبل الانتقال إلى البروكسي التالي."

    override val backupExportTitle = "تصدير البيانات"
    override val backupImportTitle = "استيراد البيانات"
    override val backupSelectExport = "ما الذي تصدِّره:"
    override val backupSelectImport = "ما الذي تستورده:"
    override val backupCopyBtn = "نسخ"
    override val backupSaveFile = "حفظ إلى ملف"
    override val backupLoadFile = "تحميل من ملف"
    override val backupDoImport = "استيراد"
    override val backupPasteLabel = "الصق JSON النسخة الاحتياطية هنا"
