...
object Ru : Strings {
    ...
    override val adaptiveHelp = "Авто-регулировка интенсивности по числу живых прокси:\n• Порог «много» " +
        "— если живых больше этого числа, проверки замедляются множителем «fast» (база уже хорошая, " +
        "экономим ресурсы).\n• Порог «мало» — если живых меньше, проверки ускоряются множителем «lazy», " +
        "чтобы быстрее набрать живых."
    override val threshMany = "Порог «много»"; override val threshFew = "Порог «мало»"; override val mulFast = "Множ. fast"; override val mulLazy = "Множ. lazy"
