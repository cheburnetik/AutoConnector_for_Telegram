...
object Prs : Strings by En {
    override val tabConnector = "ریلی"; override val tabScan = "اسکن"
    ...
    override val logSessions = "نشست‌ها"; override val logErrorsOnly = "تنها خطاها"; override val logNoErrors = "هیچ نشست ناکامی نیست"
    override fun logSession(id: String, port: String) = "#${id} · :${port}"
    override val back = "بازگشت"; override val copy = "کاپی"; override val gotIt = "فهمیدم"
    override val later = "بعداً"; override val details = "جزئیات"; override val whatIsThis = "این چیست؟"
    override val delete = "حذف"

    override val connector = "ریلی"; override val scan = "اسکن"
    override val notConfigured = "تنظیم نشده! اصلاح کنید ←"; override val howToSetup = "طریقهٔ تنظیم"
    override val notifOff = "اطلاعیه‌ها خاموش‌اند! اصلاح کنید ←"; override val enable = "فعال‌سازی"
    ...
    override fun alivePool(alive: Int, within: Int, total: Int) =
        "پروکسی‌های زنده: ${alive}  (۱۵ دقیقه: ${within}) · مجموع: ${total}"
    override val notifWhyTitle = "چرا اطلاعیه‌ها؟"
    override val notifWhyBody = "آیکون اطلاعیهٔ دائمی به معنای یک سرویس پیش‌زمینهٔ اندروید است. " +
        "بدون آن، سیستم برنامه را از حافظه تخلیه می‌کند و جستجوی پروکسی‌ها و " +
        "نگه‌داشتن اتصال در پس‌زمینه متوقف می‌شود. به همین خاطر اطلاعیه‌ها برای " +
        "کارکرد AutoConnector لازم‌اند."
    override val notifEnableTitle = "فعال‌سازی اطلاعیه‌ها"
    override val notifEnableBody = "بدون آیکون اطلاعیه، اندروید برنامه را غیرفعال در نظر می‌گیرد و " +
        ...
        "اطلاعیه‌ها را به AutoConnector بدهید."
    override val notifPlea = "اطلاعیه‌ها را فعال کنید! بدون آن‌ها برنامه نمی‌تواند در پس‌زمینه اجرا شود — " +
        "اندروید آن را تخلیه می‌کند و جستجوی پروکسی و اتصال متوقف می‌شود."

    override val statusConnected = "تلگرام وصل است"; override val statusConnecting = "در حال اتصال…"
    override val statusOffline = "تلگرام وصل نیست"; override val statusIdle = "تلگرام بی‌کار است"
    override val nobodyConnected = "کسی به ریلی وصل نشده است. "; override val howToSetupArrow = "طریقهٔ تنظیم ←"
    ...
    override val connections = "اتصالات"; override val sockets = "ساکت‌ها"; override val speed = "سرعت"
    ...
    override val currentProxy = "پروکسی فعلی"; override val noActiveProxy = "پروکسی فعالی نیست (تلگرام وصل نیست)"
    ...
    override fun activeSockets(n: Int) = "ساکت‌های فعال تلگرام: ${n}"
    override val noConnections = "اتصال فعالی نیست"; override val colHost = "میزبان"; override val colTime = "وقت"
    override val modeWord = "حالت"; override val directViaVpnLine = "درخواست‌های مستقیم به تلگرام (VPN فعال)"
    override val connModeHelp = "حالت‌ها (VPN، Wi-Fi، LTE، Ethernet، White) به شما امکان می‌دهند شدت اسکن را به‌گونهٔ متفاوت تنظیم کنید و درجه‌بندی/احصائیهٔ میزبان‌ها را جداگانه نگه دارید. کارت شبکه به‌گونهٔ خودکار تشخیص داده می‌شود؛ حالت را می‌توان به‌گونهٔ دستی در تنظیمات تعیین کرد."

    override val scanOff = "اسکن خاموش است"; override val proxiesInBase = "پروکسی‌ها در دیتابیس"
    override val total = "مجموع"; override val alive = "زنده"; override val dead = "مرده"
    override val tgConnectedTitle = "تلگرام وصل از طریق"; override val successful = "موفق"
    override val socketsHeld = "طول عمر ساکت"; override val over1m = ">۱ دقیقه"; override val over5m = ">۵ دقیقه"; override val over15m = ">۱۵ دقیقه"
    override val scanCountTitle = "تعداد بررسی پروکسی‌ها"; override val checked = "بررسی‌شده"
    override val forAllTime = "مجموع وقت"; override val perMinute = "در دقیقه"; override val perHour = "در ساعت"
    override val subsCountTitle = "تعداد دانلود اشتراک‌ها"; override val downloaded = "دانلود‌شده"; override val failed = "ناکام"; override val scanTraffic = "ترافیک اسکن"; override val subTraffic = "ترافیک اشتراک"; override val subTrafficGraph = "ترافیک اشتراک"
    override val checksMtproto = "بررسی‌های MTProto (↑ موفق · ↓ ناکام)"

    override fun catalogEmpty(mode: String) = "فهرست ${mode} فعلاً خالی است. یا هیچ میزبانی پیدا نشده، یا برنامه هرگز در این حالت اجرا نشده است. می‌توانید حالت را در تنظیمات تغییر دهید. حالت‌ها وجود دارند تا میزبان‌ها را برای انواع مختلف اتصال انترنت جداگانه جمع‌آوری کنند."
    override val aliveShort = "✓ زنده"; override val deadShort = "✗ مرده"
    override val statusLabel = "وضعیت"; override val rating = "درجه"; override val port = "پورت"
    override val rttPing = "RTT (پینگ)"; override val checkedField = "بررسی‌شده"; override val okOfTotal = "بررسی‌های موفق / مجموع"
    override val tgConnectedField = "تلگرام وصل"; override val tgSessions = "نشست‌های تلگرام"; override val trafficThroughProxy = "ترافیک از طریق پروکسی"
    override val sessionsTotal = "مجموع نشست‌ها"; override val relayNow = "ریلی اکنون"; override val tlsDomain = "دامنهٔ TLS (SNI)"
    override val sourceSub = "منبع (اشتراک)"; override val lastError = "آخرین خطا"; override val yes = "بلی"; override val no = "نخیر"
    override val copyAsLink = "کاپی به‌صورت لینک"; override val openInTelegram = "باز کردن میزبان در تلگرام"; override val makeNextRelay = "تعیین به‌حیث ریلی بعدی"
    override val actCopy = "کاپی"; override val actOpen = "باز کردن"; override val actRelay = "ریلی"
    override fun agoFmt(v: String) = "${v} پیش"
    override val catalogTopFor = "فهرست/درجه‌بندی پروکسی برای"
    override val catalogModeHelpTitle = "حالت‌ها و درجه‌بندی‌ها"
    override val catalogModeHelp = "برنامه میزبان‌های زنده و درجه‌بندی آن‌ها را به‌گونهٔ جداگانه برای هر حالت شبکه (VPN، Wi-Fi، LTE، Ethernet و White) می‌شمارد. «White» یک حالت دستی جداگانه برای فهرست‌های سفید است؛ حالت خودکار هرگز به آن سویچ نمی‌کند. بنابراین یک میزبان می‌تواند در یک حالت زنده و در حالت دیگر مرده باشد."
    override fun catalogInactiveWarn(section: String, active: String) =
        "شما در حال مشاهدهٔ بخش غیرفعال ${section} استید — همهٔ احصائیه اکنون به ${active} می‌رود، نه اینجا."
    override val manageModeTitle = "مدیریت حالت"
    override val manageResetRating = "بازنشانی درجه‌بندی"
    override fun manageResetHint(mode: String) = "برای ${mode} به‌طور خاص می‌توانید درجه‌بندی و احصائیهٔ استفادهٔ میزبان‌های زنده را بازنشانی کنید. این هنگامی مفید است که به یک VPN یا LTE کاملاً متفاوت وصل شده‌اید، تا احصائیهٔ قدیمی مزاحم نشود. یا برای تماشای اینکه اسکن پروکسی با چه سرعتی همه‌چیز را از صفر دوباره بررسی می‌کند."
    override val manageDeleteAll = "حذف میزبان‌ها در"
    override fun manageDeleteHint(mode: String) = "می‌توانید هم درجه‌بندی و هم خود میزبان‌ها را از ${mode} پاک کنید. قابلیت «اسکن پروکسی‌ها» دوباره آن‌ها را جمع‌آوری می‌کند. این بازنشانی اشتراک نیست — می‌توانید روی آن بزنید، سپس حدود ۱۵ دقیقه برای اسکن مجدد صبر کنید."
    override fun manageCopyFrom(mode: String) = "کاپی همهٔ میزبان‌ها و درجه‌بندی‌ها در این حالت (${mode}) از حالت دیگر:"
    ...
    override val connectTelegram = "اتصال تلگرام"; override val readCarefully = "به دقت بخوانید!"
    override val guideIntro = "این برنامه بدون تنظیم کار نمی‌کند. یکی از ۳ گزینهٔ زیر را انتخاب کنید " +
        "و دستورالعمل‌ها را به دقت دنبال کنید."
    ...
    override val variant2Body = "متن زیر را در Saved Messages (یا هر گفتگویی) در تلگرام کاپی کنید — " +
        "یعنی آن را برای خودتان بفرستید. روی اولین لینک در پیام‌تان بزنید — اولین پروکسی افزوده می‌شود. " +
    ...
    override val whatNextBody = "در تلگرام، \"سویچ خودکار پروکسی\" را فعال کنید — ۵ ثانیه. می‌توانید به " +
        ...
        "(۵ تا ۱۵ دقیقه). سپس تلگرام خودش به AutoConnector وصل می‌شود، که همچنان " +
        "تلگرام را از طریق بهترین پروکسی‌ها هدایت می‌کند: تأییدشده، زنده و سریع.\n\nاگر دستورالعمل‌ها مشکل به‌نظر می‌رسند " +
        "— متأسفیم، نمی‌توانید از برنامه استفاده کنید: تنظیم خودکار همه‌چیز ممکن نیست، و یافتن پروکسی‌های زنده وقت می‌گیرد.\n\nاگر مدت‌ها پیش برنامه را دانلود کرده‌اید " +
        "و هیچ پروکسی زنده‌ای پیدا نشد — یا برنامه یا فهرست اشتراک را به‌روزرسانی کنید. این برنامه " +
        "پروکسی‌های خودش را اختراع یا ارائه نمی‌کند، تنها در انترنت در میان ده‌ها " +
        "گروپ و صفحه جستجو می‌کند."
    override fun proxyBtn(port: Int) = "پروکسی ${port}"

    override val setupPortsTitle = "تنظیم پورت‌ها در تلگرام"
    override val setupPortsSub = "طریقهٔ اتصال تلگرام به ریلی (پورت‌های 55001/55002)"
    override val settings = "تنظیمات"; override val settingsSub = "پورت‌ها، anti-DPI، اسکن، شبکه، بطری"
    override val subscriptions = "اشتراک‌ها"; override val subscriptionsSub = "منابع پروکسی برای اسکن"
    override val statistics = "احصائیه"; override val statisticsSub = "دیتابیس پروکسی + ترفندهای anti-DPI"
    override val export = "اکسپورت"; override val exportSub = "لینک‌های tg:// پروکسی‌های زنده"
    override val about = "درباره"; override val aboutSub = "نسخه، بیلد، دانلود، بازخورد"
    override val hotkeys = "کلیدهای میانبر"
    override val hotkeysSub = "کلیدهای سراسری: کاپی / باز کردن یک پروکسی"
    override val hotkeysIntro = "کلیدهای میانبر سراسری حتی وقتی پنجرهٔ برنامه در فوکس نیست عمل می‌کنند. آن‌ها یک " +
        "لینک پروکسی زندهٔ تصادفی (tg://) را از استخر انتخاب می‌کنند — برای سویچ سریع پروکسی‌ها بدون " +
        "باز کردن برنامه مفید است."
    override val hotkeysNote = "در macOS، گرفتن کلیدها ممکن است به اجازهٔ Accessibility نیاز داشته باشد " +
        "(System Settings ← Privacy & Security ← Accessibility)."
    override val hotkeyCopyTitle = "کاپی لینک پروکسی"
    ...
    override val relayPorts = "پورت‌های ریلی"
    override val relayPortsHelp = "پورت‌های محلی که ریلی روی آن‌ها گوش می‌دهد. شما دقیقاً همین‌ها را در " +
        "تلگرام به‌حیث پروکسی SOCKS5 وارد می‌کنید (127.0.0.1 : پورت). برای اطمینان از دو پورت استفاده می‌شود — تلگرام " +
    ...
    override val antiDpiHelp = "روشی برای پنهان کردن اتصال تا ISP/DPI آن را تشخیص ندهد و " +
        ...
        "اتصال ساده.\n• بقیه تخنیک‌های خاص استند (تقلید براوزر، تقسیم بسته و غیره)."
    override val onlyFakeTls = "تنها FakeTLS (ee)"
    override val applyDpiTo = "تطبیق anti-DPI به"
    override val applyDpiHelp = "ترفند anti-DPI انتخاب‌شده روی چه چیزی تطبیق شود:\n• ریلی تلگرام — روی " +
        "اتصال زندهٔ تلگرام از طریق ریلی.\n• بررسی پروکسی‌ها — روی بررسی‌های پس‌زمینهٔ پروکسی " +
        "(آنگاه یک بررسی دقیقاً مثل یک اتصال واقعی رفتار می‌کند و احصائیهٔ ترفندها دقیق‌تر است).\n" +
    ...
    override val toRelay = "ریلی تلگرام"; override val toProbes = "بررسی پروکسی‌ها"
    ...
    override val vpnHelp = "وقتی VPN روی دستگاه فعال است چه کنیم:\n• از طریق پروکسی MTProto — " +
        ...
        "ریلی از پروکسی‌ها استفاده نمی‌کند و تلگرام را مستقیماً به سرورهای تلگرام وصل می‌کند: " +
        "VPN از قبل دسترسی را فراهم کرده، لایهٔ اضافی پروکسی لازم نیست (سریع‌تر و باثبات‌تر). " +
        "بدون VPN پروکسی‌ها طبق معمول استفاده می‌شوند."
    override val linkFormat = "فارمت لینک پروکسی"
    override val linkFormatHelp = "طریقهٔ کاپی و باز کردن پروکسی‌ها. tg:// تلگرام را مستقیماً باز می‌کند (به نصب Telegram Desktop نیاز دارد). http (t.me) از طریق براوزر باز می‌شود و پیشنهاد می‌دهد در تلگرام باز شود — مفید است اگر tg:// ثبت نشده باشد."
    override val linkTg = "tg:// (باز کردن مستقیم تلگرام)"; override val linkTgSub = "tg://proxy?… — تلگرام را باز می‌کند"
    override val linkHttp = "http (t.me، از طریق براوزر)"; override val linkHttpSub = "https://t.me/proxy?… — براوزر را باز می‌کند"
    ...
    override val notifications = "اطلاعیه‌ها"
    ...
    override val scanCheckHelp = "• اسکن، دقیقه — هر چند وقت یک‌بار فهرست‌های پروکسی از اشتراک‌ها دانلود شود.\n" +
        "• بررسی، دقیقه — هر چند وقت یک‌بار پروکسی‌های دیتابیس از نظر زنده بودن دوباره بررسی شوند.\n• اندازهٔ دسته — " +
        "چند پروکسی در هر اجرا بررسی شود.\n• موازی — چند بررسی به‌طور همزمان اجرا شود (بیشتر = " +
        "سریع‌تر، اما بار شبکه و بطری بالاتر)."
    ...
    override val speedByNetHelp = "هر چند وقت یک‌بار پروکسی‌ها بسته به شبکهٔ فعلی بررسی شوند. " +
        "\"معیاری\" = بازهٔ پایه. به راست بکشید برای کمتر (کندتر، ملایم‌تر برای ترافیک/بطری)، " +
        "به چپ برای بیشتر (سریع‌تر، تهاجمی‌تر). مقیاس لوگاریتمی، تا ×100 در هر جهت.\n" +
    ...
    override val maintenance = "بازنشانی معلومات"
    override val maintenanceHelp = "• \"بازنشانی فهرست و احصائیه\" — درجه‌بندی‌ها، شمارنده‌ها، ترافیک " +
        "و گزارش‌های بررسی را صفر می‌کند، اما میزبان‌های دانلودشده و اشتراک‌ها را نگه می‌دارد (همه‌چیز در " +
        "اسکن بعدی دوباره درجه‌بندی می‌شود).\n• \"پاک کردن میزبان‌های دانلودشده\" — مجموع استخر پروکسی را حذف می‌کند اما " +
        "اشتراک‌ها را نگه می‌دارد تا اسکن استخر را دوباره پر کند. اشتراک‌ها به هیچ روشی دست‌نخورده می‌مانند."
    override val backupTitle = "اکسپورت / امپورت"
    override val backupHelp = "ذخیره یا بازیابی معلومات برنامه در یک فایل JSON. آنچه را که باید " +
        "گنجانده شود تیک بزنید — هر ترکیبی:\n• تنظیمات — همهٔ پارامترهای برنامه.\n• اشتراک‌ها — فهرست " +
        "منابع (URL + روشن/خاموش).\n• فهرست میزبان‌های زنده — هر پروکسی زنده با درجه‌بندی‌ها و احصائیهٔ آن " +
        "به‌ازای هر حالت شبکه.\n\n«اکسپورت» محل ذخیره را می‌پرسد؛ «امپورت» می‌پرسد کدام فایل باز شود و " +
        "تنها بخش‌های تیک‌خوردهٔ موجود در آن را تطبیق می‌کند. امپورت به معلومات فعلی اضافه می‌کند (بدون پاک کردن)."
    ...
    override val exportWord = "اکسپورت"
    override val importWord = "امپورت"
    override val eraseAllHosts = "پاک کردن همهٔ میزبان‌ها"
    override val factoryReset = "بازنشانی همه‌چیز (مثل اولین اجرا)"
    override val factoryResetConfirm = "برنامه به‌طور کامل به حالت فابریکه بازنشانی شود؟ همهٔ تنظیمات و مجموع " +
        "فهرست میزبان‌ها پاک می‌شود، اشتراک‌ها به پیش‌فرض‌ها برمی‌گردند. درست مثل اولین اجرا."
    override val resetCatalog = "بازنشانی فهرست و احصائیه"
    override val resetCatalogConfirm = "همهٔ درجه‌بندی‌ها، شمارنده‌ها و گزارش‌های بررسی صفر شود؟ " +
        "میزبان‌های دانلودشده و اشتراک‌ها نگه داشته می‌شوند و در اسکن بعدی دوباره درجه‌بندی می‌شوند."
    override val clearHosts = "پاک کردن میزبان‌های دانلودشده"
    override val clearHostsConfirm = "مجموع فهرست میزبان‌های دانلودشده (پروکسی‌ها) حذف شود؟ " +
    ...
    override val adaptiveHelp = "بررسی‌های زنده بودن در یک بازهٔ پایه اجرا می‌شوند (از \"اسکن و بررسی\"، که در " +
        ...
        "نصف اوقات، 4 — یک‌چهارم. بطری و ترافیک را صرفه‌جویی می‌کند.\n" +
        "• بین آستانه‌ها — سرعت پایه (×1).\n\n" +
        "مثال‌ها:\n" +
        "— جمع‌آوری سریع‌تر پروکسی‌ها: \"تسریع\" 0.25 و/یا آستانهٔ \"کم\" 40.\n" +
        "— صرفه‌جویی بطری وقتی به‌اندازهٔ کافی دارید: \"کندسازی\" 8 و/یا آستانهٔ \"زیاد\" 30.\n" +
    ...
    override val baseScanHelp = "سرعت مرجع بررسی زنده بودن. «سرعت تطبیقی» و ضریب‌های «سرعت بر " +
        ...
        "رشته‌های بیشتر و دستهٔ بزرگ‌تر = رشد سریع‌تر استخر، اما بار سنگین‌تر روی شبکه و بطری."
    ...
    override val adaptiveDesc = "اگر پروکسی‌های زنده کمتر از «کم» یا بیشتر از «زیاد» باشند، یک ضریب اضافی تطبیق کن."
    ...
    override val speedByModeHelp = "یک ضریب سرعت اسکن برای هر حالت شبکه، روی سرعت " +
        "پایه. «معیاری» (×1) = بازهٔ پایه. راست — کمتر (کندتر، ملایم‌تر برای ترافیک/" +
        "بطری)، چپ — بیشتر (سریع‌تر، تهاجمی‌تر). مقیاس لوگاریتمی، تا ×100 در هر " +
        "جهت.\n\n" +
        "زیر هر اسلایدر پارامترهای گذر حاصل با سرعت تطبیقی تطبیق‌شده آمده — " +
    ...
    override val netBattery = "شبکه و بطری"
    override val netBatteryHelp = "• تنها Wi-Fi — روی شبکه‌های موبایل اسکن نکن (مصرف دیتا را صرفه‌جویی می‌کند).\n• تنها " +
        "هنگام شارژ — تنها وقتی موبایل در حال شارژ است کار کن.\n• رد کردن در بطری کم — اسکن را وقتی " +
        "بطری کم است متوقف کن."
    override val onlyWifi = "تنها Wi-Fi"; override val onlyCharging = "تنها هنگام شارژ"; override val skipLowBattery = "رد کردن در بطری کم"
    ...
    override val experimentalHelp = "موتورهای پروکسی جایگزین برای upstream MTProto به‌علاوهٔ یک گزارش تشخیصی. " +
        "مسیر مرجع (کارآمد) هنگامی که روی «خاموش» تنظیم شود تغییر نمی‌کند. تنها طریقهٔ نوشتن جریان رمزگذاری‌شده در " +
        "ساکت TCP upstream تغییر می‌کند (اندازهٔ بخش‌ها، زمان‌بندی، مرزهای رکورد TLS) — خود جریان بایت‌به‌بایت یکسان می‌ماند. " +
        "تنها روی ریلی زندهٔ پروکسی تطبیق می‌شود (نه بررسی‌ها، نه مسیر مستقیم)."
    override val expEngineTitle = "موتور پروکسی (مبهم‌سازی ساکت)"
    ...
    override val netLogSub = "چه‌کسی-به-چه‌کسی-چه‌وقتی و اندازهٔ بسته‌ها را در یک فایل می‌نویسد (بدون دیتای payload) — " +
        "برای مقایسهٔ الگوی تبادل با و بدون VPN."
    override val openLogFolder = "باز کردن فولدر گزارش"; override val copyPath = "کاپی مسیر"
    override val helpShow = "رهنما"; override val helpHide = "پنهان کردن رهنما"
    override val quickSwitchIntro = "اینجا می‌توانید یک ترفند دور زدن مسدودیت انتخاب کنید. اگر تلگرام خطای " +
        ...
        "حالت‌های *split شروع کنید. حالت‌های *coalesce هم کار می‌کنند، اما تصاویر/ویدیوها با آن‌ها در تلگرام بد بارگذاری می‌شوند."
    ...
    override fun sourceCounts(dead: Int, total: Int) =
        " زنده، ${dead} مرده، ${total} مجموع"

    override val proxyBase = "دیتابیس پروکسی"
    override val totalInBase = "مجموع در دیتابیس"; override val aliveNow = "زنده اکنون"; override val deadStat = "مرده"
    override val aliveIn15 = "زنده در ۱۵ دقیقه"; override val checksAllTime = "بررسی‌های مجموع وقت"
    override val antiDpiTricks = "ترفندهای Anti-DPI"; override val noStatsYet = "هنوز معلوماتی نیست — ترفندها با انجام بررسی‌ها/اتصالات انباشته می‌شوند"
    override val attempts = "تلاش‌ها"; override val handshake = "دست‌دهی"; override val score = "امتیاز"
    override val tgConnect = "اتصال TG"; override val socketsOver1m = "ساکت‌های >۱دقیقه"
    override val over10kb = "ساکت‌های >10KB"; override val over100kb = ">100KB"; override val workTime = "وقت کار"
    override val statsLegend = "دست‌دهی — دست‌دهی‌های موفق (٪ از تلاش‌ها) · امتیاز — مقدار · " +
        "\"وقت کار\" — مجموع روی ساکت‌های ≥5KB و طولانی‌تر از ۱ دقیقه."
    override val resetStats = "بازنشانی احصائیهٔ ترفندها"

    override fun aliveLinks(n: Int) = "لینک‌های زنده: ${n}"
    override val copyAll = "کاپی همه"
    override val openRandom = "باز کردن تصادفی"; override val copyRandom = "کاپی تصادفی"; override val allShort = "همه"
    override val copyTop = "کاپی برترین‌ها"; override val randomHost = "میزبان تصادفی"
    override val exportToFile = "اکسپورت به فایل"; override val exportSaved = "در فایل ذخیره شد:"
    ...
    override val addProxiesHelp = "دسته‌ای از لینک‌ها به پروکسی‌های مشخص را بچسبانید (tg://proxy، https://t.me/proxy، …). این اشتراک نیست — فهرست هرگز دانلود نمی‌شود، پروکسی‌ها تنها به فهرست افزوده می‌شوند."
    ...
    override val scanPlanTitle = "پلان"; override val scanNowTitle = "اکنون"; override val currentScheduleTitle = "جدول زمانی فعلی"
    override val scheduleWord = "جدول زمانی"; override val unitPcsPerSec = "عدد/ث"
    override val scanNowThreadsLabel = "رشته‌های در حال اجرا اکنون"; override val scanNowPerThreadLabel = "بررسی به‌ازای هر رشته (پلان)"; override val scanNowElapsedLabel = "وقت اجرا"
    override val scanOkGraph = "اسکن‌های موفق"; override val scanFailGraph = "اسکن‌های ناکام"; override val scanTrafficGraph = "ترافیک اسکن"; override val scanAliveGraph = "مجموع پروکسی‌های زنده"; override val scanPingGraph = "پینگ"; override val threadsGraph = "رشته‌ها"
    ...
    override val appTagline = "ریلی‌کنندهٔ خودکار چندسکویی: پروکسی‌های MTProto را که تلگرام از طریق آن‌ها " +
        "کار می‌کند پیدا، بررسی و اجرا می‌کند."
    override val version = "نسخه"; override val buildDate = "تاریخ بیلد"; override val platform = "پلتفورم"
    ...
    override val resetModeRatings = "بازنشانی درجه‌بندی میزبان‌ها"; override val forgetModeHosts = "فراموش کردن میزبان‌های حالت"
    override val exportModeTitle = "اکسپورت بر اساس حالت"; override val modePickerTitle = "حالت"
    override val modeHelp = "هر حالت شبکه درجه‌بندی پروکسی خود و شدت اسکن + دانلود اشتراک خود را نگه می‌دارد. «خودکار» حالت را از شبکهٔ فعال انتخاب می‌کند. «دستی» به شما امکان می‌دهد هر حالتی را خودتان انتخاب کنید (از جمله White، که خودکار هرگز انتخاب نمی‌کند)."
    ...
    override val wpHint = "White — WhitePages: یک پروفایل شبکهٔ دستی. تنها با دست فعال می‌شود (انتخاب خودکار هرگز آن را برنمی‌گزیند). " +
        "درجه‌بندی میزبان‌های خود را نگه می‌دارد، اشتراک‌ها را دانلود می‌کند و مستقل از VPN/Wi-Fi/LTE اسکن می‌کند."
    ...
    override val prewarmTitle = "پیش‌گرم کردن ساکت‌ها (آزمایشی)"
    override val prewarmHelp = "چند ساکت پروکسی upstream را از پیش وصل نگه می‌دارد تا یک اتصال جدید " +
        ...
        "ساکت‌ها تنها چرخش می‌یابند. بیشترین کاربرد را با پروکسی‌های FakeTLS دارد."
    override val prewarmEnable = "فعال‌سازی پیش‌گرم"
    override val prewarmModeDeferred = "تعویقی (تنها TLS)"
    override val prewarmModeDeferredSub = "TCP + FakeTLS را نگه می‌دارد؛ راه‌اندازی در وقت تحویل تکمیل می‌شود. هیچ DC تثبیت نمی‌شود — واقع‌گرایانه‌ترین."
    override val prewarmModeFull = "دست‌دهی کامل"
    override val prewarmModeFullSub = "ساکت‌های کاملاً وصل را در میان DCها نگه می‌دارد؛ تنها هنگام تطابق DC/tag دوباره استفاده می‌شود. عمر کوتاه‌تری دارند."
    override val prewarmPoolLabel = "ساکت‌های آماده‌به‌کار"
    override val prewarmHoldLabel = "نگه‌داری هر کدام، ث"
    override val prewarmNote = "تنها چرخش (بدون keepalive در سطح برنامه). یک ساکت بسته به پروکسی/DC از چند ثانیه تا حدود یک دقیقه دوام می‌آورد."
    override val prewarmStatus = "پیش‌گرم"
    override fun prewarmStatusVal(ready: Int, holdSecs: Int) = "${ready} آماده · نگه‌داری ${holdSecs}ث"
    override val prewarmStar = "نارنجی پررنگ = ساکتی که گرم از استخر پیش‌گرم تحویل داده شده (اتصال/دست‌دهی رد شد)"
    override fun prewarmTableTitle(holdSecs: Int) = "ساکت‌های پیش‌گرم (نگه‌داری ${holdSecs}ث)"
    override val prewarmTableHelp = "«ساکت‌های پیش‌گرم» چند ساکت پروکسی را از پیش باز می‌کند تا یک اتصال جدید " +
        "تلگرام بتواند مرحلهٔ اتصال/دست‌دهی را رد کند. این جدول ساکت‌های در حال گرم‌شدن را فهرست می‌کند: هر " +
        "کدام چند وقت زنده بوده، آیا تلگرام از آن استفاده می‌کند، و ترافیک. روشن/خاموش کردن و پیکربندی آن " +
        "(حالت، تعداد ساکت‌ها، وقت نگه‌داری) در «بیشتر ← تنظیمات ← „ساکت‌های پیش‌گرم (آزمایشی)“» است."
    override val prewarmNoneWarming = "هنوز ساکتی در حال گرم‌شدن نیست"
    ...
    override val lanShareDesc = "به دستگاه‌های دیگر روی این Wi-Fi اجازه دهید از این AutoConnector به‌حیث پروکسی استفاده کنند؛ براوزری که آدرس زیر را باز کند صفحه‌ای از بهترین پروکسی‌ها دریافت می‌کند."
    override val lanShareUrlsLabel = "همسایه‌های شبکه از این آدرس وصل می‌شوند:"
    override val lanShareNoIp = "آدرس شبکهٔ محلی وجود ندارد — به Wi-Fi وصل شوید"
    override val lanFirewallTitle = "اجازه در شبکهٔ محلی"
    override val lanFirewallBody = "فعال‌سازی این، پورت‌های ریلی را به شبکهٔ محلی شما باز می‌کند. اکنون فایروال Windows (یا فایروال دیگر) ممکن است بپرسد که آیا AutoConnector مجاز است — گزینهٔ Allow / Yes را انتخاب کنید. اگر رد کنید، ترافیک همسایه‌ها به AutoConnector مسدود می‌شود و صفحه/پروکسی در دسترس نخواهد بود."
    override val lanFirewallConfirm = "فعال‌سازی"
    override val lanInfoTitle = "این برای چیست؟"
    override val lanInfoBody = "AutoConnector را روی یک کمپیوتر یا تیلفون در Wi-Fi خود اجرا کنید، و هر دستگاه دیگری در همان شبکه — از جمله iPhone، که این برنامه مستقیماً از آن پشتیبانی نمی‌کند — می‌تواند تنها آدرس را در براوزر باز کند و از آن استفاده کند: صفحه‌ای از بهترین پروکسی‌ها برای افزودن به تلگرام‌شان، یا خودِ این دستگاه به‌حیث پروکسی SOCKS. یک دستگاه پروکسی‌ها را پیدا و نگه می‌دارد؛ بقیه آن را روی شبکهٔ محلی قرض می‌گیرند."
    ...
    override val volNoRights = "برنامه هنوز اجازهٔ مدیریت دکمه‌های صدا را ندارد — با گام‌های پایین این صفحه دسترسی بدهید."
    ...
    override val histLegend = "ستون‌ها — چه‌کسی: ✓/✗ TG = اتصال واقعی تلگرام، اسکن = بررسی پس‌زمینه. چه‌وقتی: چند وقت پیش. TCP/TLS/درخواست: تأخیر دست‌دهی و اولین درخواست، میلی‌ثانیه. نشست: نشست ریلی چقدر دوام آورد. ↓/↑: بایت دریافتی / ارسالی از طریق میزبان."
    override val tgOkTotalHint = "اتصالات تلگرام / موفق / مجموع بررسی‌ها"
    override val breadthTitle = "گستردگی انتخاب میزبان"
    override val breadthHelp = "چپ = به بهترین میزبان‌های اثبات‌شده پایبند بمان؛ راست = تا حد ممکن گسترده در میان همهٔ میزبان‌های زنده امتحان کن. وقتی تلگرام مدام پورت‌های ریلی را عوض می‌کند، برنامه جستجو را به‌طور خودکار گسترده می‌کند."
    ...
    // backup-page strings
    override val backupExportTitle = "اکسپورت معلومات"
    override val backupImportTitle = "امپورت معلومات"
    override val backupSelectExport = "چه چیزی اکسپورت شود:"
    override val backupSelectImport = "چه چیزی امپورت شود:"
    override val backupCopyBtn = "کاپی"
    override val backupSaveFile = "ذخیره در فایل"
    override val backupLoadFile = "بارگذاری از فایل"
    override val backupDoImport = "امپورت"
